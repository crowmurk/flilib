    ...
    $.fn.actiontable = function() {
        if (this.data.actiontable) {
            ...
            return this.each(function() {
                ...
                // Find button
                var button = $(this).find(':button[data-toggle=modal]')
                var dialog = $(this).find(button.attr('data-target'))
                    ...
                    case 1:
                        ...
                        if (dialog.length == 1)
                        {
                            button.on("click", function(event) {
                                ...
                                dialog.find(':button[data-dismiss=modal]').on("click", function(event) {
                                    event.preventDefault();
                                });
                            });
                        }
